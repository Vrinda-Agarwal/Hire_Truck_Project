      ...
      <div className={classes.overall}>
        ...
        >
          ...
          <div>
            ...
            >
              Accepted Trucks Quotes Details
            </div>
              {console.log(Rfreights)}
              
            {Rfreights.subarray_t.map((e,i) => {
            // e has truck details
              ...
              return (
                ...
                >
                  ...
                  <div className={classes.truckBoxText}>
                    ...
                    {Rfreights.subarray_t[i].dateOfShippment}
                  </div>
                  <div className={classes.truckBoxText}>
                    <span style={{ fontWeight: "bold" }}> Load Type of Freight:</span>{" "}
                    {Rfreights.subarray_t[i].loadtypeOfFreight}
                  </div>
